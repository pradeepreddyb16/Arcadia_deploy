...
# FOLLOW UP POC UPDATE
@api.route('/update_poc_details',methods = ['POST'])
def updatepocdetails():

    month1 = request.form['month1']
    month2 = request.form['month2']
  

    db.pocupdate( month1,month2)
    return jsonify ({'status':True,'msg':'poc details updated'})